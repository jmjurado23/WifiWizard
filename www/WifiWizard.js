var WifiWizard = {
  ...
  /**
   * Dissable network mobile
   */
  dissableMobileDataState: function(win, fail, data){
    if (typeof win != "function") {
			console.log("dissableMobileDataState first parameter must be a function.");
			return;
		}
    cordova.exec(win, fail, 'WifiWizard', 'dissableMobileDataState', '');
  },
